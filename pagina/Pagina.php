...
class Pagina
{
    ...
    public function inserir($dados)
    {
        ...
        $sql = "insert into pagina (nome, caminho, publica) values ('$nome','$caminho','$publica')";
//        print_r($sql); die;
...
//print_r($sql);die;
    ...
    public function existeSigla($id_pagina)
    {
        $conexao = new Conexao();

        $sql = "SELECT COUNT(*) qtd FROM pagina WHERE id_pagina ='$id_pagina';";
        $dados = $conexao->recuperarDados($sql);
    ...
    public function existeNome($nome)
    {
        ...
        $sql = "SELECT COUNT(*) qtd FROM pagina WHERE nome ='$nome';";
        $dados = $conexao->recuperarDados($sql);
